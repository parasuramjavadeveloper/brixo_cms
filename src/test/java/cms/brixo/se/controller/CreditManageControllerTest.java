...
public class CreditManageControllerTest {
    ...
    public void testGetDebtorPaymentPlans() throws Exception {
        ...
        MvcResult mvcResult = mockMvc
                ...
                .andExpect(jsonPath("response.[0].paymentPlan[0].amortization").value(333))
                .andReturn();
    ...
    public void testGetDebtor() throws Exception {
        ...
        MvcResult mvcResult = mockMvc
                .perform(get("/api/v1/debtor/101")
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("id").value(101))
                .andExpect(jsonPath("approvedAmount").value(1000))
                .andExpect(jsonPath("paybackPeriod").value("3"))
                .andExpect(jsonPath("interestRate").value(25))
                ...
                .andExpect(jsonPath("paymentPlan[0].amortization").value(333))
                .andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
        Assert.assertNotNull(response);
        Assert.assertEquals(response.getStatus(), 200);
